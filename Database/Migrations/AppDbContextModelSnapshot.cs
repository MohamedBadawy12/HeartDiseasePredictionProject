...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.AcceptAndCancelAppointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Database.Entities.MedicalTest", b =>
                {
                    ...
                    b.Property<float>("BloodPressureMedicine")
                        .HasColumnType("real");

                    b.Property<float>("CholesterolLevel")
                        .HasColumnType("real");

                    b.Property<float>("Diabetes")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("NumberOfCigarettes")
                        .HasColumnType("real");

                    b.Property<long>("PatientSSN")
                        .HasColumnType("bigint");

                    b.Property<float>("PrevalentStroke")
                        .HasColumnType("real");

                    b.Property<float>("Prevalenthypertension")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Database.Entities.MedicalTest", b =>
                {
                    b.HasOne("Database.Entities.MedicalAnalyst", "MedicalAnalystt")
                    ...
                    b.HasOne("Database.Entities.ApplicationUser", "MedicalAnalayst")
                        .WithMany()
                        .HasForeignKey("UserId");

                    b.Navigation("MedicalAnalayst");

                    b.Navigation("MedicalAnalystt");
            ...
            modelBuilder.Entity("Database.Entities.Message", b =>
                {
                    b.HasOne("Database.Entities.ApplicationUser", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId");
