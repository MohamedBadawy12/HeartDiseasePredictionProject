    ...
    public class MedicalTestsController : Controller
    {
        ...
        public async Task<IActionResult> Prediction(int id)
        {
            try
            {
                ...
                if (medicalTest == null)
                    return View("NotFound");
                if (medicalTest.Date < DateTime.Now.AddMonths(-1))
                {
                    _toastNotification.AddErrorToastMessage("Cannot make prediction for tests older than one month, " +
                        "please make new medical test");
                    return RedirectToAction("GetMedicalTests");
                }
                else
                {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            try
            {
                ...
                {
                    MedicalAnalystName = medicalTest.MedicalAnalystName,
                    BloodPressureMedicine = (int)medicalTest.BloodPressureMedicine,
                    Prevalenthypertension = (int)medicalTest.Prevalenthypertension,
                    Age = (int)medicalTest.Age,
                    BMI = (float)medicalTest.BMI,
                    Diabetes = (int)medicalTest.Diabetes,
                    DiastolicBloodPressure = (float)medicalTest.DiastolicBloodPressure,
                    CholesterolLevel = (int)medicalTest.CholesterolLevel,
                    NumberOfCigarettes = (int)medicalTest.NumberOfCigarettes,
                    Gender = medicalTest.Gender,
                    GlucoseLevel = (int)medicalTest.GlucoseLevel,
                    Smoking = (int)medicalTest.Smoking,
                    SystolicBloodPressure = (float)medicalTest.SystolicBloodPressure,
                    HeartRate = (int)medicalTest.HeartRate,
                    PrevalentStroke = (int)medicalTest.PrevalentStroke,
                };
        ...
        public async Task<IActionResult> Edit(int id, EditMedicalTestViewModel model)
        {
            try
            {
                var medicalTests = await _unitOfWork.medicalTest.GetMedicalTest(id);
                if (medicalTests == null)
                    return View("NotFound");
                string userId = User.FindFirstValue(ClaimTypes.NameIdentifier);
                string labEmail = User.FindFirstValue(ClaimTypes.Email);
                var user = await _userManager.FindByIdAsync(userId);
                medicalTests.UserId = userId;
                medicalTests.MedicalAnalystName = model.MedicalAnalystName;
                labEmail = model.LabEmail;
                medicalTests.Date = DateTime.Now;
                medicalTests.PatientSSN = model.PatientSSN;
                medicalTests.BloodPressureMedicine = model.BloodPressureMedicine;
                medicalTests.Prevalenthypertension = model.Prevalenthypertension;
                medicalTests.Age = model.Age;
                medicalTests.BMI = model.BMI;
                medicalTests.Diabetes = model.Diabetes;
                medicalTests.DiastolicBloodPressure = model.DiastolicBloodPressure;
                medicalTests.CholesterolLevel = model.CholesterolLevel;
                medicalTests.NumberOfCigarettes = model.NumberOfCigarettes;
                medicalTests.Gender = model.Gender;
                medicalTests.GlucoseLevel = model.GlucoseLevel;
                medicalTests.Smoking = model.Smoking;
                medicalTests.SystolicBloodPressure = model.SystolicBloodPressure;
                medicalTests.HeartRate = model.HeartRate;
                medicalTests.PrevalentStroke = model.PrevalentStroke;
            ...
            {
                TempData["errorMessage"] = ex.Message;
                _toastNotification.AddErrorToastMessage("Medical Test Failed");
                return View();
            }
        }
